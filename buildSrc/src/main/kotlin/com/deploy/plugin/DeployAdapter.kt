...
object DeployAdapter {
    ...
    fun adapt(project: Project) {
        ...
        val debugPkgName = if (deployExt.project.name == "app") deployExt.debugPkgName else deployExt.debugLibPkgName
        ...
        project.parent?.subprojects?.forEach { subProject ->
            ...
            val debugName = if (subProject.name == "app") deployExt.debugPkgName else libName(deployExt.debugLibPrefix, subProject)
